...
namespace TraffiLearn.Infrastructure.Migrations
{
    ...
    [Migration("20241031063904_Outbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.Directories.Directory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.Routes.Route", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.SubscriptionPlans.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.Directories.Directory", b =>
                {
                    b.OwnsMany("TraffiLearn.Domain.Aggregates.Directories.ValueObjects.Sections.DirectorySection", "Sections", b1 =>
                        {
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.Routes.Route", b =>
                {
                    b.HasOne("TraffiLearn.Domain.Aggregates.ServiceCenters.ServiceCenter", "ServiceCenter")
                        .WithMany("Routes")
            ...
            modelBuilder.Entity("TraffiLearn.Domain.Aggregates.SubscriptionPlans.SubscriptionPlan", b =>
                {
                    b.OwnsOne("TraffiLearn.Domain.Aggregates.Common.Price.Price", "Price", b1 =>
                        {
                    ...
                    b.OwnsMany("TraffiLearn.Domain.Aggregates.SubscriptionPlans.PlanFeatures.PlanFeature", "Features", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionPlanId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("TraffiLearn.Domain.Aggregates.SubscriptionPlans.RenewalPeriods.RenewalPeriod", "RenewalPeriod", b1 =>
                        {
                            b1.Property<Guid>("SubscriptionPlanId")
                                .HasColumnType("uuid");
