...
namespace TraffiLearn.Application.UseCases.SubscriptionPlans.Mappers
{
    internal sealed class CreateSubscriptionPlanCommandMapper
        : Mapper<CreateSubscriptionPlanCommand, Result<SubscriptionPlan>>
    {
        public override Result<SubscriptionPlan> Map(CreateSubscriptionPlanCommand source)
        {
            SubscriptionPlanId id = new(Guid.NewGuid());
