...
{
    internal sealed class UpdateServiceCenterCommandToEntityMapper
        : Mapper<UpdateServiceCenterCommand, Result<ServiceCenter>>
    {
        public override Result<ServiceCenter> Map(UpdateServiceCenterCommand source)
        {
