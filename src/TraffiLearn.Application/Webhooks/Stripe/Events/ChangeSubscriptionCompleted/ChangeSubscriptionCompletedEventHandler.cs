...
{
    internal sealed class ChangeSubscriptionCompletedEventHandler
        : INotificationHandler<ChangeSubscriptionCompletedEvent>
    {
        private readonly ISubscriptionPlanRepository _subscriptionPlanRepository;
        private readonly ITransactionRepository _transactionRepository;
        private readonly IUserRepository _userRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger<ChangeSubscriptionCompletedEventHandler> _logger;

        public ChangeSubscriptionCompletedEventHandler(
            ISubscriptionPlanRepository subscriptionPlanRepository,
            ITransactionRepository transactionRepository,
            IUserRepository userRepository,
            IUnitOfWork unitOfWork,
            ILogger<ChangeSubscriptionCompletedEventHandler> logger)
        {
        ...
        public async Task Handle(
            ChangeSubscriptionCompletedEvent notification,
